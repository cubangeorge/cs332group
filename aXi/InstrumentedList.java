...
public class InstrumentedList<E> extends ForwardingList<E> {
   ...
   /**
    * Adds a new object to the list with a super call after incrementing a counter
    *
   ...
   /**
    * Adds all of the input collection into the main list after incrementing a counter by how many things were added
    *
